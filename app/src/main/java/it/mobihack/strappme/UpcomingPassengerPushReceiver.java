...
public class UpcomingPassengerPushReceiver extends WakefulBroadcastReceiver {
    public UpcomingPassengerPushReceiver() {
    }

    private static final String TAG = "UpcomingPassengerPushReceiver";
    ...
    protected void myNotification(Context context, Intent intent, String className) {
        ...
        NotificationCompat.Action action1 = new NotificationCompat.Action(R.drawable.ic_launcher, "accetta", null);
        NotificationCompat.Action action2 = new NotificationCompat.Action(R.drawable.ic_launcher, "rifiuta", null);


        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(context)
                        .setSmallIcon(R.drawable.ic_launcher)
                        .setContentTitle("hanno bisogno di te!")
                        .setContentText("C'è un passeggero che chiede un passaggio!")
